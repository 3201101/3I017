		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-horizontal">
					...
					<fieldset disabled>
					<div class="form-group">
						<label for="profile_admin" class="col-sm-3 control-label">Réle</label>
						<div class="col-sm-9">
							<label>
...
<script type="text/javascript">
		...
		$.ajax({
			...
			success: function(r){
				if(r.session) {
					...
					popalert("info", "Vous étes connecté.");
				} 
				else {
	...
	$("#logout").on("click", function(){
		...
		popalert("info", "Vous étes déconnecté.");
	});
		...
		$.ajax({
			...
			success: function(r){
				if(r.username !== undefined)
				{
					...
					$("#join_username_help").text("Ce nom d'utilisateur est déjé pris.");
				}
	...
	$("#join_password").on("change", function(){
		if($("#join_password").val().length < 8){
			...
			$("#join_password_help").text("Votre mot de passe doit faire au moins 8 caractéres.");
		}
